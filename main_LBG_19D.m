...
%audio_test = {'Zero_train1.wav','Zero_train2.wav','Zero_train3.wav','Zero_train4.wav','Zero_train6.wav','Zero_train8.wav'};
...
for B = 1:length(audio_test)
    ...
    %apply notch filter
    y_t = bandstop(y_t, [10000, 11000], fs, 'Steepness',0.85, 'StopbandAttenuation',60);
